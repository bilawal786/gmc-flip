...
Route::get('/flip/{id}', 'FlipController@show')->name('flip.show');
Route::post('form/front/submit', 'FlipController@form')->name('form.front.submit');

Route::group(['middleware' => ['auth','verified']], function () {

    Route::get('/home', 'FlipController@index')->name('home');

    Route::resource('flips', 'FlipController');
